...
public class DateRangeCalendarView extends LinearLayout {
    ...
    public interface CalendarListener {
        ...
        void onCancelClick();
        void onConfirmClick(Calendar startDate, Calendar endDate);
    }
    ...
    private void initViews(Context context, AttributeSet attrs) {
        ...
        LinearLayout HeaderCalendarShow = findViewById(R.id.HeaderCalendarShow);
        HeaderCalendarShow.setBackground(calendarStyleAttr.getHeaderBg());
