package com.sfs.customcalendar.Model;
...
public class CalendarStyleAttr {
    ...
    public void setAttributes(Context context, AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            try {
                ...
                headerShow = ta.getDrawable(R.styleable.DateRangeMonthView_header_bg);
    ...
    public Drawable getHeaderShow() {
        return headerShow;
    }

    public void setHeaderShow(Drawable headerShow) {
